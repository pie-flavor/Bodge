...
val shadowJar = tasks.named<ShadowJar>("shadowJar") {
    ...
    relocate("kotlin", "flavor.pie.bodge.runtime.kotlin")
    relocate("flavor.pie.kludge", "flavor.pie.bodge.util.kludge")
}
...
publishing {
    publications {
        create("sponge", MavenPublication::class.java) {
            ...
            pom {
                name.set("Bodge")
                description.set("Lets you create bodges.")
                url.set("https://ore.spongepowered.org/pie_flavor/bodge/")
                licenses {
                    license {
                        name.set("MIT License")
                        url.set("https://github.com/pie-flavor/Bodge/blob/master/LICENSE")
                    }
                }
                developers {
                    developer {
                ...
                scm {
                    connection.set("scm:git:git://github.com/pie-flavor/Bodge.git")
                    developerConnection.set("scm:git:ssh://github.com/pie-flavor/Bodge.git")
                    url.set("https://github.com/pie-flavor/Bodge/")
                }
            }
        }
        repositories {
